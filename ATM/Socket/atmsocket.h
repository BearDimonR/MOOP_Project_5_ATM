...
private:
    ...
    enum EVENTS { START_ATM, INSERT_CARD, CHECK_PIN, SUCCESS_PIN, FREE_CARD,
                  SEND_TO_CARD, TAKE_FROM_CARD, CHECK_BAL, CHANGE_PIN, QR_SUCCESS};
...
public slots:
    ...
    void askFreeCard();
    void askValidatePin(const QString&);
    void askChangePin(const QString&);
